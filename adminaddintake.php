...
<head>
	...
	<title>Add Intakes | APU Online Assignment Submission System</title>
	<meta charset="utf-8">
...
<body>
	...
	<div class="wrapper d-flex align-items-stretch">
		...
		<div id="content" class="p-4 p-md-5 pt-5">
			<center><h2 class="mb-4">Add Intakes</h2></center>
			<p>This is the list of the APU Intakes.</p>
			<div class="container">
				<form method="POST" action="adminaddintakedtb.php">
					<label for="intakecode">Intake Code</label>
					<input type="text" id="intakecode" name="intakecode" placeholder="Enter the Intake Code" required>

					<label for="intakename">Intake Name</label>
					<input type="text" id="intakename" name="intakename" placeholder="Enter the Intake Name" required>
					...
					<h6><a href="adminintakes.php">Back to Previous Page</a></h6></center>
				</form>
			</div>
		</div>
	</div>
