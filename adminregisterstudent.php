...
<body>
	...
	<div class="wrapper d-flex align-items-stretch">
		...
		<div id="content" class="p-4 p-md-5 pt-5">
			<center><h2 class="mb-4">Students Registration</h2></center>
			<p>Key in the student information to register the student.</p>
			<div class="container">
				<form method="POST" action="adminregisterstudentdtb.php">
					...
					<?php
						...
						$result = $conn->query("SELECT intake_id, intake_name from intake");
							echo '<select name="intake" required>';
							echo "<option value=''>--Select the Intake--</option>";
					...
					<h6><a href="adminsearchstudent.php">Back to Previous Page</a></h6></center>
				</form>
			</div>
		</div>
	</div>
