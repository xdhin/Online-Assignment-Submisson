		...
		<div id="content" class="p-4 p-md-5 pt-5">
			...
			<div class="container">
				<?php
					...
					echo "<form method='POST' action='lectureraddintakemoduledtb.php?id=$intakeid'>";
				?>
					...
					<h6><a href="lecturerintakedetails.php?id=<?php echo $intakeid ?>">Back to Previous Page</a></h6></center></center>
				</form>
			</div>
		</div>
	</div>
