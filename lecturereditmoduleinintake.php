...
<body>
	...
	<div class="wrapper d-flex align-items-stretch">
		<div id="content" class="p-4 p-md-5 pt-5">
			...
			<form method="POST" action="lecturereditmoduleinintakedtb.php">
					...
					<tr>
						<td colspan="2">
							...
							<center>
								...
								<input type="submit" value="Back to Previous Page" formaction="lecturerintakedetails.php?id=<?php echo $intake ?>"/>
							</center>
						</td>
					</tr>
				</table></center>
