...
if (count($_POST) > 0) {
    ...
    if ($_POST["currentPassword"] == $row["std_password"]) {
        mysqli_query($conn, "UPDATE student set std_password='" . $_POST["newPassword"] . "' WHERE std_id='$id'");
...
<body>
	...
	<div class="wrapper d-flex align-items-stretch">
		<div id="content" class="p-4 p-md-5 pt-5">
			...
			<center><form name="frmChange" method="post" action="studentchangepassword.php?id=<?php echo $id;?>" onSubmit="return validatePassword()">
